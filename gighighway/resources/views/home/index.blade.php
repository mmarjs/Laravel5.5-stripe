...
@section('banner')
    ...
    {{--@section Banner {--}}
    <div class="banner col-lg-12 col-md-12" style="background:url('/images/banner/home-banner-{{$bannerIndex}}.jpg');
        ...
        <div id="hdivHome_BannerInnerContent">
            ...
            <div class="row">
                ...
                {!! Form::open(['route' => 'global.search', 'method' => 'POST', 'class' => 'center-block', 'style' => 'width: 50%;']) !!}
...
@endif
                        <div class="col-sm-7">
                            ...
                            <input
                                    ...
                                    placeholder="ex: Magician, Rock Band, Guitarist..." 
...
@section('main-body')
    ...
    <div class="row">
        ...
        <div id="hdivHome_TestimonialsContainer" class="col-xs-12 col-md-12 col-lg-12">
            {{-- @{ Html.RenderAction("GetTestimonials", "Home"); }--}}
