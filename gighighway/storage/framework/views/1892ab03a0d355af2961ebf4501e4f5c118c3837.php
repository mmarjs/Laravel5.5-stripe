<?php $__env->startSection('main-body'); ?>
        ...
        <div class="row">
            <div id="hdivAccount_QuickLinks">
                ...
                <div class="col-sm-4"><a href="#" class="btn btn-default">View your Quote Requests (<?php echo e($currentVendor->open_quote_request_count); ?>)</a></div>
                <div class="col-sm-4"><a href="#" class="btn btn-default">View your Reviews (<?php echo e($reviewCount); ?>)</a></div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12 dashboard_ProfileActionButtons">
                <div id="dashboard_profile_selection" class="btn-group">
                    <button type="button" class="btn btn-success dropdown-toggle"><?php echo e($currentVendor->name); ?></button>
                    <?php if($user->vendors->count() > 1): ?>
                    ...
                    <ul class="dropdown-menu">
                        <?php $__currentLoopData = $user->vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="/dashboard/switch-profiles/<?php echo e($vendor->id); ?>" class="account_ProfileOption"><?php echo e($vendor->name); ?></a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                <a href="<?php echo e(route('vendors.edit', [$currentVendor->id])); ?>" class="btn btn-primary">Edit</a>
                ...
                <a href="<?php echo e(route('vendors.create')); ?>" class="btn btn-primary pull-right">Add a New Profile</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="col-md-3 text-center">
                    <div class="row">
                        <div class="thumbnail">
                            <a href="/<?php echo e($currentVendor->slug); ?>" class="tile-link" style="overflow: hidden; position: relative;">
                                <?php if($currentVendor->profileImage): ?>
                                    <img src="<?php echo e($currentVendor->profileImage->file_url); ?>"
                            ...
                            <div class="caption tile-caption">
                                <h4><a href="<?php echo e(route('vendorProfile', [$currentVendor->slug])); ?>" id="hypProfileTile_ProfileName"><?php echo e($currentVendor->name); ?></a></h4>
                                <br>
                                <a href="<?php echo e(route('vendors.edit', [$currentVendor->id])); ?>" id="hypProfileTile_EditProfile" class="btn btn-primary btn-tile">Edit Profile</a>
                                <a href="<?php echo e(route('vendorProfile', [$currentVendor->slug])); ?>" class="btn btn-primary btn-tile" target="_blank">Preview Profile</a>
                                <a href="<?php echo e(route('vendors.edit', [$currentVendor->id])); ?>?section=plan" class="btn btn-primary btn-tile" style="display: inline-block;">Upgrade to Featured</a>
                                <a href="<?php echo e(route('vendors.billing', [$currentVendor->id])); ?>?section=payment" class="btn btn-primary btn-tile">Payment Information</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div id="hdivHomeProfile_CompletionWidget" data-profileid="10" class="dashboard-widget dashboard-widget-warning">
                                ...
                                <div class="dashboard-widget-header">
                                    <div class="db-widget-score">
                                        <a href="<?php echo e(route('vendors.edit', [$currentVendor->id])); ?>" id="hypProfile_CompletedPercentage"><?php echo e($currentVendor->completion_percent); ?> %</a>
                                    </div>
                                    <div class="db-widget-score-type">Profile Completed</div>
                                </div>
                                <div class="dashboard-widget-footer">
                                    <a id="hypProfile_CompleteYourProfile" href="<?php echo e(route('vendors.edit', [$currentVendor->id])); ?>">Complete your Profile <i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div id="hdivHomeProfile_AnalyticsWidget" data-profileid="10" data-fromdate="2/2/2018 8:43:05 AM" data-todate="3/2/2018 8:43:05 AM" class="dashboard-widget dashboard-widget-alert">
                                ...
                                <div class="dashboard-widget-header">
                                    <div id="hdivDashboard_ProfileViewCount" class="db-widget-score"><?php echo e($currentVendor->pageViews()->count()); ?></div>
                                    <div class="db-widget-score-type">Views</div>
                                </div>
                                <div class="dashboard-widget-footer">
                                    <a href="<?php echo e(route('dashboard.views.index')); ?>">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div id="hdivHomeProfile_QuoteRequestsWidget" data-profileid="10" data-href="Profile/Quote" class="dashboard-widget dashboard-widget-info">
                                ...
                                <div class="dashboard-widget-header">
                                    <div id="hdivProfile_QuoteRequestCount" class="db-widget-score"><?php echo e($currentVendor->open_quote_request_count); ?></div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <div id="hdivHomeProfile_ReviewsWidget" data-profileid="10" data-href="Profile/Review/" class="dashboard-widget dashboard-widget-info">
                                ...
                                <div class="dashboard-widget-header">
                                    <div id="hdivProfile_ReviewsCount" class="db-widget-score"><?php echo e($vendor->reviews->count()); ?></div>
